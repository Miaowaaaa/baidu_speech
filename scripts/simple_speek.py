...
class speeker():
    ...
    def define(self):
        ...
        self.Api_Key = rospy.get_param(
            '~Api_Key')  # default "pmUzrWcsA3Ce7RB5rSqsvQt2"

        self.Secrect_Key = rospy.get_param(
            '~Secrect_Key')  # default "d39ec848d016a8474c7c25e308b310c3"
        ...
        self.Speeker_url = rospy.get_param(
            '~Speeker_url')  # default 'http://tsn.baidu.com/text2audio'
        ...
        self.path = '/home/%s/%s/src/simple_voice/src/' % (self.count,
                                                           self.WorkSpaces)
